...
namespace SelectionMaker
{
    class GetFileIcon
    {
        #region Implement SHGetFileInfo
        ...
        private static IntPtr GetHandle(string filePath)
        {
            SHFILEINFO shfi=new SHFILEINFO(true);
            SHGetFileInfo(filePath, 0, out shfi,(uint) Marshal.SizeOf(shfi), SHGFI.Icon | SHGFI.SmallIcon);
            return shfi.hIcon;
        }
